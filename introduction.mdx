...
<img
  className="block dark:hidden border border-solid border-[1px]"
  src="/images/new-toolrouter-image.png"
  alt="Hero Light"
/>
<img
  className="hidden dark:block border border-solid border-[1px]"
  src="/images/new-toolrouter-image-dark.png"
  alt="Hero Dark"
/>
